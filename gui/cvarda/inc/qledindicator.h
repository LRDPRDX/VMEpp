...
class QLedIndicator : public QAbstractButton
{
    ...
    Q_OBJECT
    public:
        QLedIndicator(int size = 28, QWidget *parent = 0);
...
class QLedIndicatorWithLabel : public QWidget
{
    ...
    public :
        QLedIndicatorWithLabel( int size = 14, QString text = "", QWidget *parent = nullptr );
        void SetChecked( bool status ) { fLED->setChecked( status ); }
};
