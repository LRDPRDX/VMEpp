...
QLedIndicator::QLedIndicator(int size, QWidget *parent) : QAbstractButton(parent)
{
    setMinimumSize(size,size);
    setCheckable(true);
    onColor1 =  QColor(168, 255, 232);
...
QLedIndicatorWithLabel::QLedIndicatorWithLabel( int size, QString text, QWidget *parent ) :
    QWidget( parent )
{
    ...
    gLayout->addWidget( label, 0, 1, Qt::AlignLeft );
