...
#define V1190B_WRITE_OK_MSK                 (1U<<0U)              //the VME (master) tests the WRITE_OK bit in the Micro Handshake Register if the WO bit is set to 1, the VME can write a datum
#define V1190B_READ_OK_MSK                  (1U<<1U)              //the VME (master) tests the READ_OK bit in the Micro Handshake Register  if the RO bit is set to 1, the VME can read a datum
